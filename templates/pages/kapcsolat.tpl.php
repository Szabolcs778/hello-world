...
<label>Név:</label><input id="bekuldo" name="bekuldo" type="text" value="<?php if(isset($_SESSION['login'])) echo $_SESSION['login']; else echo "Vendég" ?>" ><br><br>
	<label>Üzenet:</label>
<textarea id="uzenet" name="uzenet"  rows="6" cols="50"></textarea><br><br>
<button type="submit" name="kuld" id="kuld">Küld</button><br><br>
